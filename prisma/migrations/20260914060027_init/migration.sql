-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MANAGER', 'ACCOUNTANT', 'STAFF', 'READ_ONLY');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('PENDING', 'ACTIVE', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "OutboxEventType" AS ENUM ('EMAIL_VERIFICATION', 'PASSWORD_RESET', 'ETIMS_INVOICE_SUBMIT', 'ETIMS_CREDIT_NOTE_SUBMIT', 'WEBHOOK', 'NOTIFICATION');
...
CREATE TABLE "organization_settings" (
    ...
    "currency" TEXT NOT NULL DEFAULT 'KES',
    "invoiceNumberFormat" TEXT NOT NULL DEFAULT 'INV-{YYYY}-{SEQ:6}',
    "defaultPaymentTermsDays" INTEGER NOT NULL DEFAULT 30,
    "financialYearStart" TEXT NOT NULL DEFAULT '01-01',
    "smtpConfig" JSONB,
    "backupConfig" JSONB,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "outbox_events_eventType_aggregateType_aggregateId_idx" ON "outbox_events"("eventType", "aggregateType", "aggregateId");
